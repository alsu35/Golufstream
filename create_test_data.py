...
departments_data = [
    ...
    {"pk": 2, "organization": 1, "name": "Производственный отдел"},
    {"pk": 3, "organization": 1, "name": "Отдел безопасности"},
    {"pk": 4, "organization": 1, "name": "Административный отдел"},
    {"pk": 5, "organization": 1, "name": "Технический отдел"},
