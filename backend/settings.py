...
SECRET_KEY = 'django-insecure-r(7$cl^h@lcto@88ms5(imlfk4dz@-mxjp*0h*6ihpp=3&352w'
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = True  # По умолчанию сессия закроется при закрытии браузера
